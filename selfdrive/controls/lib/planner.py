...
class Planner():
  def __init__(self, CP):
    ...
    self.params = Params()
    self.min_model_slowdown_speed = opParams().get('min_model_slowdown_speed', default=20.0)
  ...
  def update(self, sm, pm, CP, VM, PP):
    ...
    if len(sm['model'].path.poly):
      ...
      model_speed = max(self.min_model_slowdown_speed * CV.MPH_TO_MS, model_speed)  # Don't slow down below 20mph
    else:
