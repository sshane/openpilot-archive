...
for v_ego in p_mod_x:
  if v_ego != 78.2928:
    continue
  # traffic
  x_vel = [0.0, 4.166748138, 8.333272582, 12.50002072, 16.666768858, 20.833293302, 25.858579012, 30.5230463, 50.123114580000006, 64.610209102, 77.85781517000001, 90.35112507000001]
  y_dist = [1.384, 1.391, 1.403, 1.415, 1.437, 1.468, 1.501, 1.506, 1.3726, 1.2329, 1.1684, 1.1043]
  TR_traffic = interp(v_ego, x_vel, y_dist)
  traffic_mod_pos = [1.015, 1.65, 2.98]
  traffic_mod_neg = [1.0, 0.1, 0.05]
