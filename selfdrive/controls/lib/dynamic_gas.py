...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.CP.enableGasInterceptor:
      x = [0.0, 1.4082, 2.8031, 4.2266, 5.3827, 6.1656, 7.2478, 8.2831, MIN_ACC_SPEED]  # at 19 mph go to 0.5 (stock max gas)
      y = [0.219, 0.225, 0.237, 0.255, 0.279, 0.3, 0.339, 0.361, 0.5]  # This is the TSS1 Corolla tune, use by default for all pedal cars
      if self.candidate == CAR_TOYOTA.PRIUS:
        y = [0.3, 0.304, 0.315, 0.342, 0.365, 0.386, 0.429, 0.454, 0.5]
      elif self.candidate == CAR_TOYOTA.RAV4:
        y = [0.2574, 0.2607, 0.2706, 0.286, 0.3069, 0.3267, 0.3652, 0.3894, 0.5]
    else:
