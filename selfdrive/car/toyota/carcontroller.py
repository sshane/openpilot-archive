...
class CarController():
  def __init__(self, dbc_name, CP, VM):
    ...
    self.data_collector = DataCollector(file_path='/data/ff_data', keys=['v_ego', 'angle_steers_des', 'angle_steers', 'steer_rate', 'angle_offset', 'torque', 'time'], write_frequency=60*3)
