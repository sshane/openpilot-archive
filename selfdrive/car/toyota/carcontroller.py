...
class CarController():
    ...
    def update(self, enabled, CS, frame, actuators, pcm_cancel_cmd, hud_alert,
        ...
        apply_steer = apply_toyota_steer_torque_limits(new_steer, self.last_steer, CS.steer_torque_motor,
                                                       SteerLimitParams)
        ...
        if (frame % 3 == 0 and CS.CP.openpilotLongitudinalControl) or (pcm_cancel_cmd and ECU.CAM in self.fake_ecus):
            ...
            if pcm_cancel_cmd and CS.CP.carFingerprint == CAR.LEXUS_IS:
                ...
                can_sends.append(
                    create_accel_command(self.packer, apply_accel, pcm_cancel_cmd, self.standstill_req, lead))
            else:
        ...
        if (frame % 100 == 0 or send_ui) and ECU.CAM in self.fake_ecus:
            can_sends.append(
                create_ui_command(self.packer, steer, pcm_cancel_cmd, left_line, right_line, left_lane_depart,
                                  right_lane_depart))
