...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), vin="", has_relay=False):
    ...
    ret.longitudinalTuning.kpVPedal = [1.2, 0.8, 0.5]
    ret.longitudinalTuning.kiVPedal = [0.18, 0.12]
    ...
    if candidate == CAR.PRIUS:
      ...
      ret.lateralTuning.pid.kf = 0.0000192  # full torque for 20 deg at 80mph means 0.00007818594
      if ret.enableGasInterceptor:
