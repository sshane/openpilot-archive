...
void initializeSNPE(zdl::DlSystem::Runtime_t runtime) {
  ...
  container = zdl::DlContainer::IDlContainer::open("/data/openpilot/selfdrive/df/live_tracksv13.dlc");
  //printf("loaded model\n");
  int counter = 0;
...
vector<float> returnOutputMulti(const zdl::DlSystem::ITensor* tensor) {
...
extern "C" {
  ...
  vector<float> run_model_live_tracks(float inputData[54]){
      int size = 54;
